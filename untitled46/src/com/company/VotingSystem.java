...
public class VotingSystem {
    ...
    public void saveBinaryToFile() {
        try (FileOutputStream fileOutputStream = new FileOutputStream("d:\\voting.bin");
             ObjectOutputStream objectOutputStream = new ObjectOutputStream(fileOutputStream)) {
            for (Voting voting : votingList) {
                objectOutputStream.writeObject(voting);
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    /**
     * Save voting string in file.
     */
    public void saveTextToFile() {
        try (PrintWriter printWriter = new PrintWriter("d:\\voting.txt")) {
            for (Voting voting : votingList) {
                printWriter.println(voting.toString());
            }
        } catch (IOException e) {
            e.printStackTrace();
        }
